...
public class ResolvedLicense {
    ...
    /**
     * @return The type of matching used when the version was found. Null implies an 'all versions' match.
     */
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((this.artifactLicense == null) ? 0 : this.artifactLicense.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (this.artifactLicense == null) {
            if (other.artifactLicense != null)
                return false;
        }
        else if (!this.artifactLicense.equals(other.artifactLicense))
            return false;
